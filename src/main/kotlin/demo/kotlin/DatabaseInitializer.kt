...
internal const val USER_TO_DELETE_UUID = "856748fd-5d2e-4559-a130-73c34fbc3d3a"
...
//                .block()
        ...
        val userToDelete = User("to_delete", "to_delete", id = USER_TO_DELETE_UUID)
        listOf(fred, boss, userToDelete)
                .toFlux()
